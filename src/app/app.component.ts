...
// set products for component that equal to the productInfo
  public products: Array<productInfo> = [];

// set array productList
  private productList: Array<productInfo> = [
  {
  ...
  ngOnInit(): void {
// setting to display list of product
 this.products = this.productList;
}

onSearch(predicate: string): void {
// grabbing exported values from search component and passing string value to customer event.
